...
var _mjmlValidator = _interopRequireWildcard3(require("mjml-validator"));
var _createComponent = require("./createComponent");
var _components = _interopRequireWildcard3(require("./components"));
...
var _mjmlconfig = _interopRequireWildcard3(require("./helpers/mjmlconfig"));
...
async function mjml2html(mjml, options = {}) {
  ...
  if (minify) {
    ...
    if (isNode) {
      ...
      const nodeFormatter = await Promise.resolve().then(() => (0, _interopRequireWildcard2.default)(require('./node-only/node-formatter')));
      const formatHtml = nodeFormatter.formatHtml || nodeFormatter.default && nodeFormatter.default.formatHtml;
