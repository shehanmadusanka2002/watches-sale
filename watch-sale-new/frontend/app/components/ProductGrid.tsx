              ...
              <Link href={`/product/${product.id}`} className="w-full">
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 z-20 flex flex-col gap-3 opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-500">
                    ...
                    <div className="bg-white/90 backdrop-blur-xl p-3.5 rounded-full shadow-2xl hover:bg-black hover:text-white transition-all transform hover:scale-110 active:scale-90">
                      <Eye size={18} />
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-2 items-center w-full px-4 text-center">
                  ...
                  <h3 className="text-sm font-black text-black uppercase tracking-[0.15em] group-hover:text-indigo-600 transition-colors line-clamp-1 w-full text-center mb-1">
                    {product.name}
                  </h3>
